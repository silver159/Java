...
public class ChildT extends ParentT {
...
//		super()와 this()는 반드시 생성자의 첫 문장으로 써야한다. => 가장 먼자 실행된다.
...
//	접근할 수 없기 때문에 부모 클래스의 생성자를 호출해서 초기화시킨다.
	...
	public ChildT(String name, boolean gender, int age, String nickname) {
...
//		부모 클래스의 메소드를 실행하려면 부모 클래스를 의미하는 super 뒤에 "."을 찍고 실행할
//		메소드 이름을 쓰면 된다.
