...
public interface Calc
{
	...
	int sub(int num1, int num2); // 뺄셈,  자동으로 public abstract 붙여준다. 
	int mul(int num1, int num2); // 곱셈,  자동으로 public abstract 붙여준다.
	int div(int num1, int num2); // 나눗셈,  자동으로 public abstract 붙여준다.
}