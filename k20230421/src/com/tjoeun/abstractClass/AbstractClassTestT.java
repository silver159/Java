...
//	추상 메소드가 포함된 클래스를 상속받는 자식 클래스에서 반드시 Override 시켜서 사용해야
//	하는 메소드이다. => 프로그래머에게 반드시 Override를 해서 사용하게끔 강제한다.
	
//	자식 클래스에서 반드시 Override 시켜서 사용해야 한다는 강제성을 프로그래머에게 부여하고
//	추상 메소드의 {} 블록에 팔아프게 코딩해봐야 자식 클래스에서 Override를 하게되면 부모 클래스에서
//	정의 메소드이 내용은 무시되므로 팔아프게 {} 블록의 내용을 코딩해봐야 어차피 무시될거 {} 블록을
//	아예 코딩하지 않는다.
...
class CameraT extends ProductT {
...
public class AbstractClassTestT {
