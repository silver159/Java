...
//	static을 붙여서 선언 상수는 "="를 사용해서 초기화 시켜야 하고
//	static을 붙이지 않고 선언한 상수는 "="를 이용해도 되고 생성자를 이용해도 된다.
...
//	인터페이스는 필드는 무조건 상수만 가질 수 있으므로 필드 선언시 앞의 내용을 생략하면
...
interface GraphicsT extends DrawT, GraphicT {
...
class LineT extends PointT implements DrawT, GraphicT {
...
//		Shape.PI = 1.2345; // 에러
		...
		System.out.println("Draw.PI: " + DrawT.PI);
		System.out.println("Draw.LIMIT: " + DrawT.LIMIT);
