...
class Unit
{
	...
	// 상수를 초기화 시키는 방법은 3가지가 있는데 1번째 방법은 상수 선언시
...
class GroundUnit extends Unit
{
	...
	// ⑥ GroundUnit 클래스의 생성자가 종료되면 GroundUnit 클래스의 생성자를 호출한 곳으로
	// 돌아간다.
}
...
class Tank extends GroundUnit implements Repairable
{
	...
	{
		super(150);
		// ⑦ Tank의 MAX_HP가 150으로 초기화되었으므로 현재 HP(상속받은 current_HP)를
		// MAX_HP로 초기화시킨다.
		current_HP = MAX_HP;
		System.out.println("Tank의 현재 HP는 " + current_HP + " 입니다.");
	}
	@Override
...
class Marine extends GroundUnit implements healing
{
	...
	public Marine()
	{
		super(80);
		current_HP = MAX_HP;
		System.out.println("Marine의 현재 HP는 " + current_HP + " 입니다.");
	}
...
class Medic extends GroundUnit implements healing
{
	...
	public Medic()
	{
		super(70);
		current_HP = MAX_HP;
		System.out.println("Medic의 현재 HP는 " + current_HP + " 입니다.");
	}
	...
	{
		if (healing instanceof Unit)
		{
			Unit unit = (Unit)healing;
			unit.current_HP = 50;
			while(unit.current_HP<unit.MAX_HP)
			{
				unit.current_HP++;
				System.out.print(".");
				try
...
class SCV extends GroundUnit implements Repairable
{
	...
	{
		super(100);
		System.out.println("SCV의 현재 HP는 " + current_HP + " 입니다.");
	}
	@Override
	public String toString()
	{
...
class DropShip extends AirUnit implements Repairable
{
	...
	{
		super(120);
		System.out.println("DropShip의 현재 HP는 " + current_HP + " 입니다.");
	}
