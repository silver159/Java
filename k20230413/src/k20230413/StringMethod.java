...
//		trim(): 문자열 앞, 뒤의 불필요한 빈칸(공백)을 제거한다. 자주 사용됨
...
//		숙제
		...
		System.out.println(str.substring(0, start+1)+ "*".repeat(last-start-1)+ str.substring(last));
		System.out.println("==================");
		String[] abc = str.split("-");
		int a = abc[1].length();
		abc[1] = "*".repeat(a);
		System.out.printf("%s-%s-%s",abc[0],abc[1],abc[2]);
		System.out.println();
