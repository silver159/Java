...
//		ArrayList<Integer> list = new ArrayList<Integer>(); // JDK 1.5 버전 이후, 사용가능
		ArrayList<Integer> list = new ArrayList<>(); // JDK 1.7 버전 이후. <> 생략 가능하다.
...
//		ArrayList도 인덱스가 범위를 벗어나면 IndexOutOfBoundsException가 발생된다.(0~19)
